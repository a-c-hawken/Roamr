...
//                }),
    ...
    func webView(_ webViewL WKWebview, didFail navigation: WKNavigation!, withError error: Error) {
        ...
        UIAlertController(title: "Webpage Failed to Load", message: "Webpage", webView.url?.absoluteString, " failed to load", preferredStyle: UIAlertController.Style)
    }
