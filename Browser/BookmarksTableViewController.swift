...
class BookmarksTableViewController: UITableViewController, BookmarkDelegate {
    func didSelectBookmark(url: URL, title: String) {
        let newBookmark = Bookmark(title: title, url: url.absoluteString)
        bookmark.append(newBookmark)
        print ("recieved and saved url: ", newBookmark.url!, " title: ", newBookmark.title!)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = bookmark[indexPath.row].title
        return cell
    }
